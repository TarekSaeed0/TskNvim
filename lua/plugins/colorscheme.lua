		...
		opts = {
			custom_highlights = function(colors)
				...
				return {
					...
					SnacksDashboardKey = { fg = colors.mantle, bg = colors.mauve, bold = true },
					SnacksDashboardKeyLeftSeparator = { fg = colors.mauve },
					SnacksDashboardKeyRightSeparator = { fg = colors.mauve, bg = colors.mantle },
