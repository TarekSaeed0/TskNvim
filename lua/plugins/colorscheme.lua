		...
		opts = {
			custom_highlights = function(colors)
				...
				return {
					...
					SnacksDashboardFooter = { fg = colors.overlay0, bg = colors.mantle },
					SnacksDashboardFooterLeftSeparator = { fg = colors.mantle },
					SnacksDashboardFooterRightSeparator = { fg = colors.mantle },
